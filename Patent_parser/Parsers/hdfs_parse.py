...
for organisation in organisations:
    ...
    for i in range(page-1):
        ...
        for link in links:
            ...
            row = [Id, abstract_text, description_string, claim_string]
            data = [row]
            client.insert('hdfs_fields', data,
                          column_names=['Patent_Id', 'Abstract','Description', 'Claim'], database="db_patents")
            Id += 1
